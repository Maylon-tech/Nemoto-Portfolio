...
const Navbar = ({openNav}:Props) => {
  ...
  const stickyStyle = navSticky ? "bg-[#122428] shadow-gray-900 shadow-sm" : ""

  return (
    <div className={`fixed w-[100%] ${stickyStyle} transition-all duration-300 z-[1000]`}>
      <div className="flex items-center h-[12vh] justify-between w-[80%] mx-auto">
        <div className="font-logo text-white text-[25px]">
            <span className="text-[30px] md:text-[40px] text-yellow-400">MN</span>
            Developer
        </div>
