...
const NavMobile = ({ closeNav, showNav }:Props) => {
  ...
  return (
    <div className="">
        ...
        <ul className={`text-white ${navOpenStyle} fixed flex items-center flex-col justify-center h-[100%] transform transition-all duration-300 delay-300 w-[60%] bg-red-600 space-y-14 z-[100006]`}>
        <li>
        ...
        <XMarkIcon onClick={closeNav} className="absolute top-[-1.4rem] right-[1.4rem] w-[2.3rem] h-[2.2rem] text-white" />
      </ul>
    </div>
  )
}
