    ...
    <div className="grid w-[80%] mx-auto pt-[5rem] grid-cols-1 lg:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <p className="text-white opacity-65 text-[15px] mt-[1rem]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt aspernatur dolor iure ex illum eligendi asperiores nesciunt, esse nam exercitationem, soluta magnam. Optio debitis minus ipsam dolore repellat reprehenderit quod illum voluptatem, voluptate, odio, excepturi adipisci non unde voluptates? Totam, labore nesciunt!
        </p>
        <div className="mt-[1.3rem] grid-cols-2 grid sm:grid-cols-3 xl:grid-cols-4 gap-[2rem]">
            ...
            <h1 className="px-3 py-3 bg-blue-500 text-white rounded-lg text-center">{tech4}</h1>
        </div>
      </div>
    </div>
  )
